...
if hasattr(account_report, "to_csv"):
    account_report.to_csv("user/account_report.csv", index=False)
if hasattr(positions_report, "to_csv"):
    positions_report.to_csv("user/positions_report.csv", index=False)
if hasattr(order_fills_report, "to_csv"):
    order_fills_report.to_csv("user/order_fills_report.csv", index=False)
...
create_tearsheet(
    engine=engine,
    output_path="user/backtest_results.html",
)
